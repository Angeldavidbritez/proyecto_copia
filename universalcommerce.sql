...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-10-2023 a las 05:10:54
...
--
-- Base de datos: `universalcommerce`
--
...
--
-- AUTO_INCREMENT de la tabla `datos_emprendimientos`
--
ALTER TABLE `datos_emprendimientos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `inverciones`
--
ALTER TABLE `inverciones`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `tipo_emprendimiento`
--
ALTER TABLE `tipo_emprendimiento`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `comentarios`
  ...
  ADD CONSTRAINT `comentarios_ibfk_2` FOREIGN KEY (`emp_id`) REFERENCES `emprendimientos` (`id`);

--
-- Filtros para la tabla `datos_emprendimientos`
--
ALTER TABLE `datos_emprendimientos`
  ADD CONSTRAINT `datos_emprendimientos_ibfk_1` FOREIGN KEY (`emp_id`) REFERENCES `emprendimientos` (`id`);

--
-- Filtros para la tabla `emprendimientos`
--
ALTER TABLE `emprendimientos`
  ADD CONSTRAINT `emprendimientos_ibfk_1` FOREIGN KEY (`creador_id`) REFERENCES `usuarios` (`ID`),
  ADD CONSTRAINT `emprendimientos_ibfk_2` FOREIGN KEY (`datos_id`) REFERENCES `info_emprendimiento` (`id`);
...
--
ALTER TABLE `inverciones`
  ADD CONSTRAINT `inverciones_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`ID`),
  ADD CONSTRAINT `inverciones_ibfk_2` FOREIGN KEY (`emp_id`) REFERENCES `emprendimientos` (`id`);
